...
from . import frontend_api, views
...
urlpatterns = [
    ...
    path(
        "new-remove-paper-permanently",
        views.new_remove_paper_permanently,
        name="new_remove_paper_permanently",
    ),
    ...
    path(
        "new-remove-review-permanently",
        views.new_remove_review_permanently,
        name="new_remove_review_permanently",
    ),
    ...
    path(
        ...
        views.delete_review_forever,
        name="delete_review_forever",
    ),
    path("fetch-rank-list", views.fetch_rank_list, name="fetch_rank_list"),
    path(
        "fetch-rank-full-list", views.fetch_rank_full_list, name="fetch_rank_full_list"
    ),
    ...
    path(
        "groups/<str:group_name>/", frontend_api.get_group_info, name="get_group_info"
    ),
    path(
        "groups/<str:group_name>/reviews/",
        frontend_api.get_group_reviews,
        name="get_group_reviews",
    ),
    path(
        "groups/<str:group_name>/reviews/<int:review_id>/",
        frontend_api.get_single_review,
        name="get_single_review",
    ),
    path(
        "groups/<str:group_name>/users/<int:user_id>/",
        frontend_api.get_user_reviews,
        name="get_user_reviews",
    ),
    path(
        "groups/<str:group_name>/journals/<str:journal_name>/",
        frontend_api.get_journal_reviews,
        name="get_journal_reviews",
    ),
    path(
        "groups/<str:group_name>/rank/<str:rank_type>/",
