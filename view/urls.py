...
urlpatterns = [
    ...
    path('trash/<int:id>/delete', views.DeletePaperView, name='delete_forever'),
    ...
    re_path(r'^ajax/fetch/user/(?P<user>.+)', views.AjaxFetchUser, name='ajax_fetch_user'),
    re_path(r'^ajax/fetch/doi/(?P<doi>.+)', views.AjaxFetchDOI, name='ajax_fetch_doi'),
    re_path(r'^ajax/fetch-raw/doi/(?P<doi>.+)', views.AjaxFetchRawDOI, name='ajax_fetch_raw_doi'),
]
